...
(global-set-key "\C-r" 'org-capture)
...
(add-hook 'org-mode-hook
          '(lambda ()
             ...
             (define-key org-mode-map [(control meta a)] 'outline-previous-visible-heading)
             (define-key org-mode-map [(control meta e)] 'outline-next-visible-heading)
             ))
...
(add-hook 'org-agenda-mode-hook
          '(lambda ()
             (define-key org-agenda-mode-map [(control c) (control c)] 'org-agenda-set-tags)
...
(setq org-agenda-custom-commands
      (quote (
              ...
              ("r" "Remembered" tags-todo "-@TASKS-@HABIT/-CANCELLED-WAITING-SOMEDAY"
               ((org-agenda-overriding-header " Remembered things")
              ...
              ("p" "Postponed" todo "SOMEDAY|WAITING"
...
(setq org-capture-templates
      `(
        ("t" "TODO LIST" entry (file
                                ,(concat GTD-directory "task.org"))
         "* TODO %?
")

        ("r" "Remembered Things" entry (file+headline
